...
# Add the DarcyAI components that we need, particularly the InputStream, OutputStream, Pipeline,
# and PerceptorMock
...
class SingleStreamDemo():
    """
    SingleStreamDemo is a class that implements a simple pipeline that has one input stream
    """
    ...
    # Define an input callback for the mock perceptor that just sends the data onward with no
    # manipulation
