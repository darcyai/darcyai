...
class AudioAnalyzer():
    """
    This class is used to run the audio analysis pipeline.
    """
    def __init__(self):
    ...
    # Define a callback to work with the incoming audio data before it passes into the audio
    # analysis perceptor
    ...
    # Perform audio feature extractions using Numpy that we will pass to the audio analysis
    # AI perceptor
    def __extract_features(self, data):
        """
        This method is used to extract features from the audio data.
        """
