...
class AudioAnalysisPerceptor(Perceptor):
    ...
    def __init__(self):
        # Get the directory of our code and then get the TensorFlow Lite AI model file and the AI
        # labels file
    ...
    # Define our "run" method which is where the Perceptor does its processing against the current
    # data
    ...
    # Define our "load" method which is used by the Darcy AI Pipeline to set up our custom
    # Percpetor
    # pylint: disable=unused-argument
    def load(self, accelerator_idx=None):
        ...
        self.__interpreter = tflite.Interpreter(model_path=self.model_path,
